...
namespace DefendUranus.Activities
{
    ...
    class GamePlaySetup : GameActivity<GamePlaySetup.Result>
    {
        ...
        IEnumerable<ShipDescription> LoadShips()
        {
            ...
            yield return new ShipDescription(Content, "Sprites/Meteoroid", "Meteoroid Alienform", SpecialAttack("Meteoroid Seeker"), mass: 3, maxSpeed: 30, fuel: TimeSpan.FromSeconds(4), normalAmmo: 25, specialAmmo: 2) { ParticleColor = Color.Green };
